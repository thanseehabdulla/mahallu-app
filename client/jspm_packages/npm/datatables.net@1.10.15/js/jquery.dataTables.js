  ...
  (function(factory) {
    ...
    function _fnFilterCustom(settings) {
      ...
      var row,
          rowIdx;
      for (var i = 0,
          ien = filters.length; i < ien; i++) {
        var rows = [];
        for (var j = 0,
            jen = displayRows.length; j < jen; j++) {
    ...
    function _fnGetMaxLenString(settings, colIdx) {
      var s,
          ...
          maxIdx = -1;
      for (var i = 0,
          ien = settings.aoData.length; i < ien; i++) {
    ...
    _addNumericSort('');
    $.extend(true, DataTable.ext.renderer, {header: {
